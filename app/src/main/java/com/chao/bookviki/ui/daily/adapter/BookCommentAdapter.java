...
import com.chao.bookviki.widget.CircleImageView;
...
public class BookCommentAdapter extends RecyclerView.Adapter<BookCommentAdapter.ViewHolder>{
    ...
    private List<BookCommentBean.CommentsBean> mList;
    ...
    public BookCommentAdapter(Context mContext, List<BookCommentBean.CommentsBean> mList) {
        this.mList = mList;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        BookCommentBean.CommentsBean info = mList.get(position);
